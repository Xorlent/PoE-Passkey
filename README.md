# PoE-Passkey
![Cheesy PoE-Passkey AI Image](https://github.com/Xorlent/PoE-Passkey/blob/main/images/PoE-Passkey.gif)  
PoE-Passkey is designed for an M5Stack **Unit-PoE-P4**, a power-over-Ethernet device 
that acts as a **hardware-key gate**. It turns users tapping a security key (a YubiKey, Thetis Nano, or 
...
- [Arduino IDE](https://www.arduino.cc/en/software) with the `esp32 by Espressif Systems` board manager package.
